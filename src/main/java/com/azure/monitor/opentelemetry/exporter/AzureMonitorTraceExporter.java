...
final class AzureMonitorTraceExporter implements SpanExporter {
  ...
  public AzureMonitorTraceExporter(SpanDataMapper mapper, TelemetryItemExporter telemetryItemExporter, QuickPulse quickPulse) {
    this.mapper = mapper;
    this.telemetryItemExporter = telemetryItemExporter;
  ...
  public CompletableResultCode export(Collection<SpanData> spans) {
    ...
    if(quickPulse != null) {
      for (SpanData span : spans) {
        TelemetryItem telemetryItem = mapper.map(span);
